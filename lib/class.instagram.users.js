  ...
  InstagramUsers = (function() {
    ...
    */
    ...
    InstagramUsers.prototype.follows = function(params) {
      params = this.parent._credentials(params, 'access_token');
      params['path'] = "/" + this.parent._api_version + "/users/" + params['user_id'] + "/follows?" + (this.parent._to_querystring(params));
      return this.parent._request(params);
    };

    InstagramUsers.prototype.followed_by = function(params) {
      params = this.parent._credentials(params, 'access_token');
      params['path'] = "/" + this.parent._api_version + "/users/" + params['user_id'] + "/followed-by?" + (this.parent._to_querystring(params));
      return this.parent._request(params);
    };

    InstagramUsers.prototype.requested_by = function(params) {
      params = this.parent._credentials(params, 'access_token');
      params['path'] = "/" + this.parent._api_version + "/users/self/requested-by?" + (this.parent._to_querystring(params));
      return this.parent._request(params);
    };
